...
class NetworkComponets extends IpAddress {
  ...
  showIpAddress() {
    ...
    article.innerHTML = `
        ...
        <p><strong>Broadcast: </strong> <span class="results-section--decimalORstringText">${this.broadcastDecimal.join(".")}</span> <span style="white-space: nowrap;"><span class="results-section--binaryPart">${this.networkBinary}</span> <span class="results-section--binaryText">${this.machineBinaryInOne}</span></span></p>
